...
function CreateVehicule() {
  ...
  const handleLocationCar = (e) => {
    setLocationCar(e.target.value);
  };
  ...
  const handleSubmitPhoto = (e) => {
    e.preventDefault();
    // if (carPhotoRef.current.files[0]) {
    //   // recupération des articles.
    //   const myHeader = new Headers();
    //   myHeader.append("Authorization", `Bearer ${token}`);

    //   const formData = new FormData();
    //   formData.append("carPhoto", carPhotoRef.current.files[0]);
  ...
  //   fetch("http://localhost:5000/carPhoto", requestOptions)
  //     .then((response) => {
  //       response.json();
  //       notifySuccesAvatar();
  //     })
          ...
          <div className="flex justify-center my-2 mx-4 md:mx-0">
            ...
            >
              <div className="flex flex-col -mx-3 mb-6">
                ...
                <div className="className=w-full px-3 mb-6">
                  <label
                    className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                    htmlFor="Password"
                  >
                  ...
                  <input
                    ...
                    type="text"
                    maxLength="200"
                    placeholder="36 Rue Roger Radisson, 69005 Lyon"
                    required
                    onChange={handleLocationCar}
                    value={locationCar}
                  />
                </div>
